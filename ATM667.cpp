...
enum enMainMenueOptions {
    ...
    eCheckBalance = 4, eChangePinCode = 5, eExit = 6
};
...
string ReadPinCode(sClient& Client)
{
    string PinCode = "";
...
string ReadNewPinCode()
{
    ...
    cout << "please enter the new pincode: \n";
    cin >> NewPinCode;

    return NewPinCode;
}

void PerformChangePinCodeAction(sClient& Client)
{
    string NewPinCode = "";
    vector<sClient> vClients;
    string PinCode = ReadPinCode(Client);
    vClients = LoadCleintsDataFromFile(ClientsFileName);

    char Answer = 'n';

    cout << "\n\nAre you sure you want to change the pincode? y/n: ";
    cin >> Answer;
    if (Answer == 'y' || Answer == 'Y')
    {
        for (sClient& C : vClients)
...
void ShowChangePinCodeScreen()
{
    ...
    cout << "===========================================\n";
    PerformChangePinCodeAction(CurrentClient);
}
